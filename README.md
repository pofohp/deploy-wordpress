...
# Note:
When using a self-signed certificate, this video file can be downloaded  
only if the page embedding it has already been opened in the browser.  
Directly downloading the video URL without first loading the webpage  
may result in a "Network Error" due to TLS trust and browser security checks.  
